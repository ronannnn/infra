...
func (srv *Service) Start(ctx context.Context, emailChan chan EmailEntity) (err error) {
...
func (srv *Service) Fetch(emailNo uint32) (emailEntities []*EmailEntity, err error) {
