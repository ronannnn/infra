...
func (ua UserAgent) DeviceType() DeviceType {
	if ua.Mobile {
		return Mobile
	}
	if ua.Tablet {
...
func Parse(userAgent string) UserAgent {
	...
	// if chrome and Safari defined, find any other token sent describing browser
...
// ignore return true if token should be ignored
